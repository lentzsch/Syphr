...
const OutputBox = () => {
    ...
    useEffect (() => {
        if (socket == undefined){
            socket = io('https://syphr.herokuapp.com/', { transports: ['websocket'] });
    ...
    return (
        <div className="output-box-container">
            <div className="output-box">
                ...
                />
                {userId && currentConversation && message && <button className="enigma-send-button" type="submit" onClick={sendMessage}>Send</button>}
