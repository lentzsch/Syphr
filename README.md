...
## NOTE! This was my old capstone project and while it's not bad for a two week solo project to graduate App Academy, there are many issues with it from a real world production standpoint. I am currently revisiting it and plan on forking and refactoring it, creating a "before and after" to showcase my growth.
